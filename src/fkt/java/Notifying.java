package fkt.java;
/**
Potential element of the FacetsJava notification tree.
<p>{@link Notifying} is the root of the FacetsJava type hierarchy
...
<p>Whenever a target acts on the element it represents in the 
  ...
  control consistency. 
<p>Notification is triggered in the FacetsJava implementation of by calling {@link #notify(Object)}
...
the FacetsJava framework typically ensures that notification
