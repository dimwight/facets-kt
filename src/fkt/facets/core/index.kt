...
fun targetStateUpdated(state:SimpleState,title:String):Unit?;
}
...
interface Times{
var doTime:Boolean
fun setResetWait(millis:Int):Unit
fun elapsed():Int
fun traceElapsed(msg:String):Unit
}
interface Facets{
...
fun addContentTree(add:Target):Unit
fun activateContentTree(title:String):Unit
fun attachFacet(title:String,updater:FacetUpdater):Unit
fun updateTargetState(title:String,update:SimpleState):Unit
fun getTargetState(title:String):SimpleState
fun notifyTargetUpdated(title:String):Unit
fun updateTargetWithNotify(title:String,update:SimpleState):Unit
fun setTargetLive(title:String,live:Boolean):Unit
fun isTargetLive(title:String):Boolean
var supplement:Any
fun buildApp(app:FacetsApp):Unit
fun newInstance(trace:Boolean):Facets
}
interface FacetsApp{
fun getContentTrees():Array<Target> 
fun onRetargeted(activeTitle:String):Unit
fun buildLayout():Unit
}
