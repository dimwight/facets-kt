...
import fkt.util.NumberPolicy;
import fkt.util.Util;
/**
...
<p>{@link SNumeric} represents a numeric value to 
  ...
  mechanism and policy can be defined in a {@link fkt.core.SNumeric.Coupler}. 
 */
final public class SNumeric extends TargetCore{
	...
	public static class Coupler extends TargetCoupler{
		/**
		Returns the policy to be used by a {@link fkt.core.SNumeric} 
		...
		/**
		Defines client-specific mechanism for a {@link fkt.core.SNumeric}. 
	...
	<p>The policy is that returned by the {@link fkt.core.SNumeric.Coupler} 
